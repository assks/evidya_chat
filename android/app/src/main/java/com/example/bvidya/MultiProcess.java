...
import static com.example.bvidya.model.Examples.ADVANCED;
...
import com.bvidya.R;
import com.example.bvidya.utils.CommonUtil;
...
public class MultiProcess extends BaseFragment implements View.OnClickListener {
    ...
    String rtchannal, rtctoken, Sshare;
    private FrameLayout fl_local, fl_remote;
    private Button join,screenShare;
    private EditText et_channel;
    private RtcEngine engine;
    private int myUid;
    private final String appid = "d6306b59624c4e458883be16f5e6cbd2";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rtchannal = getArguments().getString("rtm");
        rtctoken = getArguments().getString("rtctoken");
        Sshare = getArguments().getString("share");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        try {
            engine = RtcEngine.create(context.getApplicationContext(), appid, iRtcEngineEventHandler);
            mSSClient = ScreenSharingClient.getInstance();
            mSSClient.setListener(mListener);
            mSSClient.start(getContext(), getString(R.string.agora_app_id), rtctoken, rtchannal, SCREEN_SHARE_UID, new VideoEncoderConfiguration(getScreenDimensions(), FRAME_RATE_FPS_30, STANDARD_BITRATE, ORIENTATION_MODE_ADAPTIVE));
        } catch (Exception e) {
            e.printStackTrace();
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(context, "Your application is minimize to start screen-share", Toast.LENGTH_SHORT).show();
            }
        }, 9000);
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_join) {
            ...
            String channelId = rtchannal /*et_channel.getText().toString()*/;
            // if (!isSharing) {
            mSSClient.start(getContext(), getString(R.string.agora_app_id), rtctoken /*getString(R.string.agora_access_token)*/, channelId, SCREEN_SHARE_UID, new VideoEncoderConfiguration(getScreenDimensions(), FRAME_RATE_FPS_30, STANDARD_BITRATE, ORIENTATION_MODE_ADAPTIVE));
    ...
    private void joinChannel(String channelId) {
        ...
        String accessToken = rtctoken/*getString(R.string.agora_access_token)*/;
    ...
    private final IRtcEngineEventHandler iRtcEngineEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onJoinChannelSuccess(String channel, int uid, int elapsed) {
            Log.d("resdfd", getString(R.string.agora_app_id) + rtctoken /*getString(R.string.agora_access_token)*/);
        ...
        public void onRemoteVideoStateChanged(int uid, int state, int reason, int elapsed) {
            ...
            minimizeApp();
            Toast.makeText(ctx, "Your application is minimize to start screen-share", Toast.LENGTH_SHORT).show();
        }
